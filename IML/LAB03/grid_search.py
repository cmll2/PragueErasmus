...
def main(args: argparse.Namespace) -> float:
    ...
    pipeline = sklearn.pipeline.Pipeline(steps=[("min_max_scaler", min_max_scaler), ("polynomial_features", polynomial_features), ("logistic_regression", logistic_regression)])
    ...
    grid_search = sklearn.model_selection.GridSearchCV(pipeline, param_grid={"polynomial_features__degree": [1, 2], "logistic_regression__C": [0.01, 1, 100], "logistic_regression__solver": ["lbfgs", "sag"]}, cv=sklearn.model_selection.StratifiedKFold(5))
